...
<body class="bg-light">
    <div class="text-center p-5">
        ...
        <h4><b>Script last modified:</b> <span style="color:#236c82;font-style:italic"><?php date_default_timezone_set('UTC');
                                                                                        echo date("F d Y H:i:s A", filemtime(__FILE__)); ?> (UTC)</span> <a href="https://github.com/omer123137/TikTok-Video-Downloader/commits/master" rel="nofollow" title="Click to view commits history in github" target="_blank">Check Logs</a></h4>
    ...
    <div class="bg-dark text-white" style="position: fixed; bottom: 0;width: 100%;padding:15px">Developed by <a target="_blank" href="https://www.github.com/omer123137">omer123137</a> <span style="float: right;">Copyright &copy; <?php echo date("Y"); ?></span></div>
    <script type="text/javascript">
